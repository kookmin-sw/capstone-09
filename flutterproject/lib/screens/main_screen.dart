...
class _LoginSignupScreenState extends State<LoginSignupScreen> {
  ...
  void _tryValidation() {
    final isValid =
        _formKey.currentState!.validate(); //모든 텍스트 폼필드에 validation 작동
    if (isValid) {
          ...
          children: [
            ...
            Positioned(
              ...
              child: Container(
                ...
                width:
                    MediaQuery.of(context).size.width - 40, //기종에 맞게 넓이 알아서 조절
                        ...
                        try {
                          ...
                          ScaffoldMessenger.of(context).showSnackBar(
                            SnackBar(
                              ...
                              backgroundColor:
                                  Color.fromARGB(255, 146, 168, 209),
                            ),
                          );
                        }
                      }
